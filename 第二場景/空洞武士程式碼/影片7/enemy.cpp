...
{
    {
    // Setting up animations for aiming
...

{
        ...
        animation_dash_in_air_vfx_left.set_anchor_mode(Animation::AnchorMode::Centered);
        animation_dash_in_air_vfx_left.add_frame(ResourcesManager::instance()->find_atlas("enemy_vfx_dash_in_air_left"));
        ...
        animation_dash_in_air_vfx_right.set_anchor_mode(Animation::AnchorMode::Centered);
        animation_dash_in_air_vfx_right.add_frame(ResourcesManager::instance()->find_atlas("enemy_vfx_dash_in_air_right"));
        ...
        animation_dash_on_floor_vfx_left.set_anchor_mode(Animation::AnchorMode::BottomCentered);
        animation_dash_on_floor_vfx_left.add_frame(ResourcesManager::instance()->find_atlas("enemy_vfx_dash_on_floor_left"));
        ...
        animation_dash_on_floor_vfx_right.set_anchor_mode(Animation::AnchorMode::BottomCentered);
        animation_dash_on_floor_vfx_right.add_frame(ResourcesManager::instance()->find_atlas("enemy_vfx_dash_on_floor_right"));
